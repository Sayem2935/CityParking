    ...
    <div className="space-y-5">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-black">
        <img
          ...
          alt="Captured face for enrollment"
        ...
        <div className="rounded-xl bg-green-900/30 border border-green-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-semibold text-green-800">Enrollment Successful!</h4>
              <p className="text-xs text-green-400">Your face has been enrolled for recognition.</p>
              {enrollmentRecord && (
                <div className="mt-2 text-xs text-green-700 space-y-0.5">
                  ...
                  <p>Provider: <span className="font-semibold">{enrollmentRecord.provider}</span></p>
                  {enrollmentRecord.confidence > 0 && (
                    <p>Confidence: <span className="font-semibold">{(enrollmentRecord.confidence * 100).toFixed(1)}%</span></p>
                  )}
                </div>
              )}
            </div>
      ...
      {isUploading && (
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span className="font-medium text-zinc-300">Uploading & processing face...</span>
